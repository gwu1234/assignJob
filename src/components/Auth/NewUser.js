...
"Cette application est basée sur la base de données Google Cloud et sur la carte GPS.Il gère les clients, les prospects, les commandes, les contrats, les factures, les paiements, les livraisons, les camions.Il se compose de trois parties: port de gestion pour le bureau (Google Chrome est suggéré), application Apple et application Android pour les employés.Il prend en charge l'anglais et le français. Nous offrons un mois gratuit pour le procès.Vous pouvez commencer par enregistrer et configurer votre propre base de données,ou vous pouvez nous contacter (duty2go@gmail.com).Nous allons configurer un compte de test et une base de données pour vous."
    :
    "This application is based on Google cloud database and gps map.It manages clients, leads, workorders, contracts, invoices, payments, deliveies, trucks.It comes in three parts: management port for office desktop (Chrome is suggested), Apple app and Android app for employees.It supports both English and French. We offer a free month for trial.You can start with registering and setting up your own database,or you can contact us (duty2go@gmail.com).We will set up a testing account and database for you.";
